...
def test_invalid_product_creation():
    ...
    with pytest.raises(ValueError):
        Products(name="MacBook Air M2", price=-10.0, quantity=100) # Negatve price should raise ValueError
...
# Test 5: Bying a larger quantity than is available on stock raises an exception
